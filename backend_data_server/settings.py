...
SECRET_KEY = "django-insecure-*r3z-p+1oj(lvm6w!op&unl2j56$yant_j7$_30l@ponp@jswa"
...
FIREBASE_CREDENTIALS_PATH = credentials.Certificate("backend_data_server/secrets/landing-key.json")
...
firebase_admin.initialize_app(FIREBASE_CREDENTIALS_PATH, {
   'databaseURL': 'https://landing-6e41f-default-rtdb.firebaseio.com/'
})
